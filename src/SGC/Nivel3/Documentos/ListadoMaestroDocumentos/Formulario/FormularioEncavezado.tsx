...
import { FormDataEncabezado, schemaEncabezado } from "../Typos";

type FormularioEncabezadoProps = {
  setEncabezadoData: React.Dispatch<
    React.SetStateAction<FormDataEncabezado | null>
  >;
};

export const FormularioEncabezado: React.FC<FormularioEncabezadoProps> = ({
  setEncabezadoData,
}) => {
  const {
    control,
    ...
    resolver: zodResolver(schemaEncabezado),
  });

...
export const schemaEncabezadoSolicitudPersonal = z.object({
    idSolicitudPersonal: z
    .number()
...
export type FormDataEncabezadoSolicitudPersonal = z.infer<
  typeof schemaEncabezadoSolicitudPersonal
>;

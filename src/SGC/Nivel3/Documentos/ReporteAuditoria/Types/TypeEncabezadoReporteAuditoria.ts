...
export const schemaEncabezadoReporteAuditoria = z.object({
  idReporteAuditoria: z
    .number()
...
export type FormDataEncabezadoReporteAuditoria = z.infer<
  typeof schemaEncabezadoReporteAuditoria
>;
